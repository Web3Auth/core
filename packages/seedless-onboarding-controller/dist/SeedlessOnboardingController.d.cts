...
import type { AuthenticateUserParams, CreateSeedlessBackupParams, Encryptor, NodeAuthTokens, OAuthVerifier, UpdatePasswordParams } from "./types.cjs";
...
export declare class SeedlessOnboardingController extends BaseController<typeof controllerName, SeedlessOnboardingControllerState, SeedlessOnboardingControllerMessenger> {
     ...
     */
    authenticateOAuthUser(params: AuthenticateUserParams): Promise<import("./ToprfClient.cjs").AuthenticationResult>;
    /**
...
export {};
//# sourceMappingURL=SeedlessOnboardingController.d.cts.map